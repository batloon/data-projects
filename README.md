...
|-|-|-|-|-|
| Smartphone Brands Ranked By Active Use Score | Analyzing smartphone active use scores across different manufacturers and models. | Technology | In Progress | [README](https://github.com/batloon/data-projects/blob/main/smartphone_active_use_score/README.md) |
